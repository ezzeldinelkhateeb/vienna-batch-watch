...
const en: Dict = {
  ...
  kpiQuarantine: "Quarantine & Inspection",
  kpiTotalStockBalance: "Actual Warehouse Stock Balance",
  ...
  // Production Dispense & Stock Movements
  dispenseToProduction: "Dispense to Production",
  dispenseSubtitle: "Record raw material dispatch to production lines with automatic FEFO checking",
  productionLine: "Production Line",
  quantityToDispense: "Quantity to Dispense",
  currentStockBalance: "Current Stock Balance",
  remainingBalanceAfter: "Remaining Balance After Dispense",
  fefoWarningTitle: "FEFO Priority Notice",
  fefoWarningDesc: "Batch #{batch} expires earlier ({days} days). We recommend dispensing it first to minimize waste.",
  switchToFefoBatch: "Switch to Earliest Batch",
  recipientTechnician: "Recipient / Operator Name",
  dispenseSuccess: "Raw material dispensed successfully",
  stockMovements: "Stock Movements Log",
  movementHistory: "Movement History",
  dispenseAll: "Dispense All (100%)",
  lineWafer: "Wafer Biscuit Line",
  lineMoulding: "Chocolate Moulding & Bars Line",
  lineCreams: "Creams & Fillings Line",
  linePackaging: "Packaging & Wrapping Line",
  lineQcLab: "QC Lab / Product Development",

  // Waste Prevention Dashboard
  wastePrevention: "Waste Prevention & Expiry Risk",
  wastePreventionSubtitle: "Predictive analytics to consume near-expiry batches before loss occurs",
  criticalRiskUnder7: "Critical Risk (< 7 Days)",
  highRisk30: "High Risk (8 – 30 Days)",
  mediumRisk60: "Medium Risk (31 – 60 Days)",
  safeStock: "Safe Stock (> 60 Days)",
  factorySafetyScore: "Inventory Safety Score",
  urgentProductionMatrix: "Urgent Production Matrix",
  suggestedLine: "Recommended Line",
  quickDispense: "Quick Dispense",
  shareReportWhatsApp: "Send Report via WhatsApp",
  printWasteReport: "Print Waste Prevention Plan",

  // Stock Exit & Archive System
  stockExitArchive: "Exit / Archive",
  stockExitArchiveTitle: "Stock Exit & Archive",
  stockExitArchiveSubtitle: "Record sales, warehouse transfers, distributions, or archive depleted stock",
  activeInventory: "Active Inventory",
  archivedInventory: "Archive & Depleted",
  archiveTabDesc: "Historical record of finished batches, sold items, and transferred materials without deleting data",
  moveToArchive: "Move to Archive",
  restoreFromArchive: "Restore to Active Stock",
  restoreConfirm: "Restore this item back to active inventory?",
  permanentDelete: "Permanent Delete",
  permanentDeleteConfirm: "Are you sure you want to permanently delete this item and all its history? This action cannot be undone.",
  saleToCustomer: "Sale to Customer",
  transferWarehouse: "Transfer to Another Warehouse",
  distributionSamples: "Distribution / Samples",
  depletedZeroBalance: "Depleted (Zero Balance)",
  directArchive: "Direct Archive",
  exitQuantity: "Quantity to Exit",
  allQuantity: "All (100%)",
  customerName: "Customer / Buyer Name",
  destinationWarehouse: "Destination Warehouse / Branch",
  recipientPerson: "Recipient / Driver Name",
  invoiceOrPrice: "Sale Price / Invoice #",
  archiveNotes: "Notes & Remarks",
  exitSuccess: "Stock exit and movement logged successfully",
  archiveSuccess: "Item successfully moved to the Archive",
  restoreSuccess: "Item restored to active inventory successfully",
  noArchivedItems: "No archived items yet",
  noArchivedItemsDesc: "Finished, sold, or transferred items will appear here for long-term tracking and data retrieval without deletion.",
  zeroStockPrompt: "Stock depleted (0) — Move to archive",
};
...
const ar: Dict = {
  ...
  kpiQuarantine: "قيد الفحص والاعتماد",
  kpiTotalStockBalance: "إجمالي رصيد المخزن الفعلي",
  ...
  // Production Dispense & Stock Movements
  dispenseToProduction: "صرف لخط الإنتاج",
  dispenseSubtitle: "تسجيل صرف المواد الخام لخطوط الإنتاج مع التحقق التلقائي من أولوية الصرف (FEFO)",
  productionLine: "خط الإنتاج المستلم",
  quantityToDispense: "الكمية المراد صرفها",
  currentStockBalance: "الرصيد الحالي بالمخزن",
  remainingBalanceAfter: "الرصيد المتبقي بعد الصرف",
  fefoWarningTitle: "تنبيه أولوية الصرف (FEFO)",
  fefoWarningDesc: "التشغيلة #{batch} تنتهي في موعد أقرب (بعد {days} يوم). ننصح بصرفها أولاً لتفادي تلف الخامات.",
  switchToFefoBatch: "التحويل للتشغيلة الأسبق انتهاءً",
  recipientTechnician: "اسم المستلم / فني التشغيل",
  dispenseSuccess: "تم تسجيل صرف الخامة وتحديث رصيد المخزن بنجاح",
  stockMovements: "سجل حركات الصرف والمخزن",
  movementHistory: "سجل الحركات",
  dispenseAll: "صرف كامل الرصيد (100%)",
  lineWafer: "خط بسكويت ويفر",
  lineMoulding: "خط صب الشوكولاتة والبارات",
  lineCreams: "خط الكريمات والحشوات",
  linePackaging: "خط التعبئة والتغليف",
  lineQcLab: "معمل الجودة والتطوير",

  // Waste Prevention Dashboard
  wastePrevention: "منع الهالك وتوقعات الصلاحية",
  wastePreventionSubtitle: "لوحة ذكية لتحليل الخامات قريبة الانتهاء وحمايتها من التلف المالي",
  criticalRiskUnder7: "خطر داهم (أقل من 7 أيام)",
  highRisk30: "خطر مرتفع (8 – 30 يوم)",
  mediumRisk60: "خطر متوسط (31 – 60 يوم)",
  safeStock: "مخزون آمن (> 60 يوم)",
  factorySafetyScore: "مؤشر الأمان المخزني",
  urgentProductionMatrix: "مصفوفة أولوية التشغيل العاجلة",
  suggestedLine: "الخط المقترح للتشغيل",
  quickDispense: "صرف فوري",
  shareReportWhatsApp: "إرسال التقرير عبر واتساب",
  printWasteReport: "طباعة خطة مكافحة الهالك",

  // Stock Exit & Archive System
  stockExitArchive: "إخراج / أرشفة",
  stockExitArchiveTitle: "إخراج المخزون ونقل للأرشيف",
  stockExitArchiveSubtitle: "تسجيل بيع الصنف، أو نقله لمخزن آخر، أو توزيعه، أو أرشفة المخزون المنتهي لحفظ بياناته وتاريخه",
  activeInventory: "المخزون الحالي",
  archivedInventory: "أرشيف المنتهية والمبيعات",
  archiveTabDesc: "سجل تاريخي للأصناف المنتهية، والمباعة، والمنقولة مع الاحتفاظ بكافة حركاتها وبياناتها دون حذفها",
  moveToArchive: "نقل إلى الأرشيف",
  restoreFromArchive: "استعادة للمخزون النشط",
  restoreConfirm: "هل ترغب في استعادة هذا الصنف إلى قائمة المخزون النشط؟",
  permanentDelete: "حذف نهائي من قاعدة البيانات",
  permanentDeleteConfirm: "هل أنت متأكد من الحذف النهائي لهذا الصنف وسجلاته من قاعدة البيانات؟ لا يمكن التراجع عن هذا الإجراء.",
  saleToCustomer: "بيع لعميل",
  transferWarehouse: "نقل لمخزن آخر",
  distributionSamples: "توزيع / عينات وهدايا",
  depletedZeroBalance: "نفاد المخزون بالكامل",
  directArchive: "أرشفة يدوية مباشرة",
  exitQuantity: "الكمية المراد إخراجها",
  allQuantity: "كامل الكمية (100%)",
  customerName: "اسم العميل / المشتري",
  destinationWarehouse: "المخزن أو الفرع المحول إليه",
  recipientPerson: "اسم المستلم أو السائق",
  invoiceOrPrice: "سعر البيع / رقم الفاتورة أو الإيصال",
  archiveNotes: "ملاحظات وتفاصيل إضافية",
  exitSuccess: "تم تسجيل حركة الإخراج وتحديث الرصيد بنجاح",
  archiveSuccess: "تم نقل الصنف بنجاح إلى شاشة الأرشيف",
  restoreSuccess: "تمت استعادة الصنف إلى المخزون النشط بنجاح",
  noArchivedItems: "لا توجد أصناف في الأرشيف حالياً",
  noArchivedItemsDesc: "الأصناف التي ينفد رصيدها أو يتم بيعها ونقلها للأرشيف ستظهر هنا مع الاحتفاظ بكافة سجلاتها التاريخية وإمكانية استعادتها.",
  zeroStockPrompt: "المخزون نفد (0) — نقل للأرشيف",
};
